...
//     Alert.alert("Erro ao Salvar", "Email já cadastrado", [{text: "OK", onPress: () => {setShowModal(false)}}], {cancelable: true});
//   }
...
//     const res = await axios.get(api + "listar.php?busca=" + query);
//     setList(res.data.result);
   
//   }

//   async function add() {
//     const obj = {name, email, password, id};
//     const res = await axios.post(api + "add.php", obj);
...
//     if(res.data.success == 403) { //Email já cadastrado
//       duplicationAlert();
//     }
//     showData();
//     setShowModal(true);
